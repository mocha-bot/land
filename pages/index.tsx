    ...
    <Container maxW={"3xl"}>
      ...
      >
        ...
        <Stack
          ...
          position={"relative"}
        >
          <Link href="https://discord.com/api/oauth2/authorize?client_id=987974524140146728&permissions=414465853504&scope=applications.commands%20bot">
            <Button
              bg={"#7A4526"}
              color={"white"}
              rounded={"full"}
